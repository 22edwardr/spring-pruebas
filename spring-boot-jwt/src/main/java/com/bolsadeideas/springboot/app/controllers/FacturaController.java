...
public class FacturaController {
	...
	public String ver(Model model,@PathVariable(value="id") Long id,RedirectAttributes flash, Locale locale) {
		Factura factura;
		factura = clienteService.fetchByIdWithClienteWithItemFacturaWithProducto(id);
	...
	public String crear(Model model, @PathVariable(value="clienteId") Long clienteId, RedirectAttributes flash, Locale locale) {
	...
	public @ResponseBody List<Producto> cargarProductos(Model model, @PathVariable("term") String term) {
