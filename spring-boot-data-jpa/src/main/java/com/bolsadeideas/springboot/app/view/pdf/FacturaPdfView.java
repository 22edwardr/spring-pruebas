...
//El componente se llama igual que la vista que estaria renderizando la clase la cual extiende este componente hace que 
// renderize esta vista cuando el formato sea pdf se puede añadir un .pdf en el nombre del componente para diferenciarlo
// de otros componentes vista que compartan la misma vista pero en otro formato
...
public class FacturaPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		// Otra manera de traducir los textos utilizando la interfaz de AbstractPdfView
