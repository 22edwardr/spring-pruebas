...
//El .xlsx se añade ya que no puede existir dos componentes con el mismo nombre el xlsx se coloca para especificar que esta sera
//la vista que renderizara para factura/ver cuando el format=xlsx
